    ...
    public partial class Calculadora : Form
    {
        ...
        public void Calculadora_Load(object sender, EventArgs e)
        {
            if ((contadormodo % 2) == 0)
            {
                ...
                buttonMas.BackColor = Color.Lavender;
                buttonMenos.BackColor = Color.Lavender;
                buttonMultiplicacion.BackColor = Color.Lavender;
                buttonDividir.BackColor = Color.Lavender;
                buttonIgual.BackColor = Color.Lavender;
                buttonBorrar.BackColor = Color.Lavender;
